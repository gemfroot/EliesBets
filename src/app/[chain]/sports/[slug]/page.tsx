...
/**
 * Chain comes from the URL segment, not a cookie, so this route is statically
 * generable. We still mark it as `revalidate = 45` so list data refreshes
 * server-side without forcing per-request rendering.
 */
